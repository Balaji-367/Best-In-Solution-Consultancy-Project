    ...
    <div className="p-6 md:p-8 lg:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-green-600 mb-2">Available Jobs</h1>
          ...
          <div className="flex items-center gap-4 mt-4 md:mt-0">
            ...
            <p className="text-green-600 font-medium">{currentDate}</p>
          </div>
        </div>

        {/* Section Title */}
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-green-600 mb-2">Available Service Jobs</h2>
            ...
            <div key={job.id} className="card">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 text-green-600">
                      ...
                      {job.latitude && job.longitude && (
                          <a
                            ...
                            className="ml-1 text-xs text-blue-600 hover:text-blue-800 underline flex items-center gap-1"
                  ...
                  <div className="flex flex-wrap gap-2">
                    {job.skills.map((skill, index) => (
                      <span key={index} className="px-3 py-1 bg-background-grey text-green-600 rounded-full text-sm">
                        {skill}
                      </span>
                    ))}
                  </div>
                ...
                <button
                  ...
                  className="btn-green flex items-center gap-2 whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
                >
