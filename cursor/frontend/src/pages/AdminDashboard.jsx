...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background-light">
      ...
      {/* Sidebar */}
      <div className={`fixed lg:static inset-y-0 left-0 z-50 transform transition-transform duration-300 ease-in-out lg:translate-x-0 w-64 flex-shrink-0 ${
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Mobile Header */}
        <header className="lg:hidden bg-white border-b border-border-light flex-shrink-0 z-30">
